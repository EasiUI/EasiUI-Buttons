export default function Spinner4(){
    return(
           <div className="">
<svg width="24" height="24" className="inline w-14 h-14 mr-2 text-gray-200  dark:text-gray-600 fill-yellow-600" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
